...
case "$ARCH" in
    x86_64)  DEB_ARCH=amd64;  RPM_ARCH=x86_64;   PKG_ARCH=x86_64;  APK_ARCH=x86_64  ;;
    aarch64) DEB_ARCH=arm64;  RPM_ARCH=aarch64;   PKG_ARCH=aarch64; APK_ARCH=aarch64 ;;
    armv7|armv7l|armhf) DEB_ARCH=armhf; RPM_ARCH=armv7hnl; PKG_ARCH=armv7h; APK_ARCH=armv7 ;;
    i686|i386|x86) DEB_ARCH=i386; RPM_ARCH=i686; PKG_ARCH=i686; APK_ARCH=x86 ;;
...
build_pacman() {
    ...
    # Use bsdtar to create a .pkg.tar.zst (same format as pacman)
    # This avoids needing makepkg which requires a full Arch chroot
